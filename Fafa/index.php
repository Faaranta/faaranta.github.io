...
<head>
	...
	<title>The Wedding of Fatma & Agik</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="The Wedding of Fatma and Agik" />
	<meta name="keywords" content="wedding, wedding invitation, invitation, the wedding" />
	<meta name="author" content="Fatma & Agik" />

	<!-- Facebook and Twitter integration -->
	<meta property="og:type" content="website">
	<meta property="og:title" content="The Wedding of Fatma and Agik"/>
	<meta property="og:image" content="images/readme/half%20circle-200.png"/>
	<meta property="og:url" content="https://ngodingsolusi.github.io/the-wedding-of-Fatma-Agik/"/>
	<meta property="og:site_name" content="The Wedding of Fatma and Agik"/>
	<meta property="og:description" content="The Wedding of Fatma and Agik. Open source wedding invitation"/>

	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:site" content="@ngodingsolusi" />
	<meta name="twitter:creator" content="@ngodingsolusi" />
	<meta name="twitter:title" content="The Wedding of Fatma and Agik" />
	<meta name="twitter:description" content="Open Source Wedding Invitation. The Wedding of Fatma and Agik" />
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					...
					<br>
					<p>
						<a href="https://calendar.google.com/event?action=TEMPLATE&tmeid=NW0zY2Ewam91bnUzbW5ub2YwdjVxaTliNmUgcDY4MjI3cmY0dTJ0cWI1b3JrZjEwbTN1NDRAZw&tmsrc=p68227rf4u2tqb5orkf10m3u44%40group.calendar.google.com" target="_blank" class="btn btn-primary btn-sm">Save the date</a><br>
		...
		<div class="container">
			...
			<div class="couple-wrap animate-box">
				<div class="couple-half">
					<div class="groom">
						<img src="images/Fatma-square.jpg" alt="groom" class="img-responsive">
					</div>
					<div class="desc-groom">
						<h3>Fatmawati Batra</h3>
						<p><span style="color: #bf9b73">Putri Ketiga dari</span><br>
							<span class="parents-font">Bapak xxxx</span>
							<br>
							<span class="parents-font">Ibu yyyy</span>
						</p>
						<div id="social-media-Fatma">
							<ul class="fh5co-social-icons">
								<li><a target="_blank" href="https://github.com/rayhanyulanda"><i class="icon-github-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.linkedin.com/in/rayhanyulanda/"><i class="icon-linkedin-with-circle"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="couple-half">
					<div class="bride">
						<img src="images/Agik-square.jpg" alt="groom" class="img-responsive">
					</div>
					<div class="desc-bride">
						<h3>Muhammad Fachrul Argianta</h3>
						...
						<div id="social-media-molid">
							<ul class="fh5co-social-icons">
								<li><a target="_blank" href="https://github.com/Agikdev"><i class="icon-github-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.linkedin.com/in/Agikdev/"><i class="icon-linkedin-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.instagram.com/Agiknashuha/"><i class="icon-instagram-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.facebook.com/Agiknashuha"><i class="icon-facebook-with-circle"></i></a></li>
								<li><a target="_blank" href="https://twitter.com/ngodingsolusi"><i class="icon-twitter-with-circle"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-md-6 col-sm-6 text-center">
						<div class="event-wrap animate-box">
							...
							<div class="event-col">
								...
								<span>Sabtu</span>
								<span class="tanggal">7 Desember 2024</span>
							</div>
							<p style="font-family: 'Courgette', Arial, serif">Alamat : Klaten</p>
	...
	<div id="fh5co-testimonial" style="background: url('images/background/repeat-background/so-white.png'); background-repeat:repeat; border-top: 1px solid #f2f2f2">
		...
		<div class="container">
			...
			<div id="button-send" class="text-center animate-box">
				<a href="https://github.com/Agikdev/nikah-Fatma-Agik/issues/new/choose" target="_blank" class="btn btn-primary btn-sm">Kirim Ucapan</a><br>
		...
		<div class="container">
			...
			<div class="row copyright animate-box">
				<div class="col-md-12 text-center">
					...
					<img src="images/readme/half%20circle-2300.png" width="100" height="100">
					<br>
					<h1 style="font-family: 'Satisfy', Arial, serif">Fatma & Agik</h1>
					<p>
						Created by M. Fachrul Argianta </br>
						<small>template by NgodingSolusi</small>
					<ul class="fh5co-social-icons">
						<li><a target="_blank" href="https://wa.me/6285360061021/"><i class="icon-phone"></i></a></li>
						<li><a target="_blank" href="https://nikahdigital.com/"><i class="icon-globe"></i></a></li>
						<li><a target="_blank" href="https://www.instagram.com/nikahdigitalcom/"><i class="icon-instagram"></i></a></li>
						<li><a target="_blank" href="https://github.com/Agikdev"><i class="icon-github"></i></a></li>
						<li><a target="_blank" href="https://www.linkedin.com/in/Agikdev/"><i class="icon-linkedin"></i></a></li>
					</ul>
					</p>
				</div>
			</div>
...
<script>
	...
	$.get( "https://api.github.com/repos/ngodingsolusi/the-wedding-of-Fatma-Agik/issues?state=all&per_page", function( data ) {
...
<script>
	...
	function togglePlayButton1(play) {
		document.getElementById("youtube-icon1").src = play ? "https://ngodingsolusi.github.io/the-wedding-of-Fatma-Agik/images/audio/pause.png" : "https://ngodingsolusi.github.io/the-wedding-of-Fatma-Agik/images/audio/play.png";
	}
...
<script type="text/javascript">
	...
	const inlineGallery = lightGallery(lgContainer, {
		...
		dynamicEl: [
			{
				src: 'images/gallery/20211107182627_IMG_5230.jpg-10241x.jpg',
				thumb: 'images/gallery/20211107182627_IMG_5230.jpg-10241x.jpg',
				/*subHtml: `<div class="lightGallery-captions">
					<h4>Caption 1</h4>
					<p>Description of the slide 1</p>
				</div>`,*/
			},{
				src: 'images/gallery/IMG_9958.JPG-10241x.jpg',
				thumb: 'images/gallery/IMG_9958.JPG-10241x.jpg',
				/*subHtml: `<div class="lightGallery-captions">
					<h4>Caption 1</h4>
					<p>Description of the slide 1</p>
				</div>`,*/
			},{
				src: 'images/gallery/molid.jpg-10241x.jpg',
				thumb: 'images/gallery/molid.jpg-10241x.jpg',
				/*subHtml: `<div class="lightGallery-captions">
					<h4>Caption 1</h4>
					<p>Description of the slide 1</p>
				</div>`,*/
			},{
				src: 'images/gallery/Fatma.jpg-10241x.jpg',
				thumb: 'images/gallery/Fatma.jpg-10241x.jpg',
				/*subHtml: `<div class="lightGallery-captions">
					<h4>Caption 1</h4>
					<p>Description of the slide 1</p>
				</div>`,*/
			},{
				src: 'images/gallery/ring-3.JPG-10241x.jpg',
				thumb: 'images/gallery/ring-3.JPG-10241x.jpg',
				/*subHtml: `<div class="lightGallery-captions">
					<h4>Caption 1</h4>
					<p>Description of the slide 1</p>
				</div>`,*/
			},{
				src: 'images/gallery/20211107181957_IMG_5207.jpg-10241x.jpg',
				thumb: 'images/gallery/20211107181957_IMG_5207.jpg-10241x.jpg',
				/*subHtml: `<div class="lightGallery-captions">
					<h4>Caption 1</h4>
					<p>Description of the slide 1</p>
				</div>`,*/
			},{
				src: 'images/gallery/IMG_9797.JPG-10241x.jpg',
				thumb: 'images/gallery/IMG_9797.JPG-10241x.jpg',
				/*subHtml: `<div class="lightGallery-captions">
					<h4>Caption 1</h4>
					<p>Description of the slide 1</p>
				</div>`,*/
			},{
				src: 'images/gallery/IMG_9802.JPG-10241x.jpg',
				thumb: 'images/gallery/IMG_9802.JPG-10241x.jpg',
				/*subHtml: `<div class="lightGallery-captions">
					<h4>Caption 1</h4>
					<p>Description of the slide 1</p>
				</div>`,*/
			},{
				src: 'images/gallery/IMG_9787-10241x.jpg',
				thumb: 'images/gallery/IMG_9787-10241x.jpg',
				/*subHtml: `<div class="lightGallery-captions">
					<h4>Caption 1</h4>
					<p>Description of the slide 1</p>
				</div>`,*/
